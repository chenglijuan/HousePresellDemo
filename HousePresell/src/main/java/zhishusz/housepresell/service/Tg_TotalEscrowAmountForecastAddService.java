...
/*
 * Service添加操作：托管总资金的预测结存
 * Company：ZhiShuSZ
 * */
@Service
@Transactional
public class Tg_TotalEscrowAmountForecastAddService
{
	@Autowired
	...
	public Properties execute(Tg_TotalEscrowAmountForecastForm model)
	{
		...
		Tg_TotalEscrowAmountForecast tg_TotalEscrowAmountForecast = new Tg_TotalEscrowAmountForecast();
