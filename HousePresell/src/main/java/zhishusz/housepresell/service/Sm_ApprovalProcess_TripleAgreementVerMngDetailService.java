...
@Service
@Transactional
public class Sm_ApprovalProcess_TripleAgreementVerMngDetailService {
	@Autowired
	...
	public Properties execute(Tgxy_TripleAgreementVerMngForm model)
	{
		...
		Tgxy_TripleAgreementVerMng tgxy_TripleAgreementVerMng = (Tgxy_TripleAgreementVerMng) tgxy_TripleAgreementVerMngDao
				.findById(Tgxy_TripleAgreementVerMngId);
		if (tgxy_TripleAgreementVerMng == null)
		{
			return MyBackInfo.fail(properties, "该三方协议管理信息已失效，请刷新后重试");
		}
		...
		sm_AttachmentForm.setBusiType("06010103");
