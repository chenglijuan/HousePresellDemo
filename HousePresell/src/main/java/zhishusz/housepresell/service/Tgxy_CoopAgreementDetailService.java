...
@Service
@Transactional
public class Tgxy_CoopAgreementDetailService
{
	@Autowired
	...
	public Properties execute(Tgxy_CoopAgreementForm model)
	{
		...
		if (tgxy_CoopAgreement == null || S_TheState.Deleted.equals(tgxy_CoopAgreement.getTheState()))
		{
		...
		properties.put("tgxy_CoopAgreement", tgxy_CoopAgreement);
