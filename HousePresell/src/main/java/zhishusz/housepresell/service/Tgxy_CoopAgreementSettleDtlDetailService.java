...
@Service
@Transactional
public class Tgxy_CoopAgreementSettleDtlDetailService
{
	@Autowired
	...
	public Properties execute(Tgxy_CoopAgreementSettleDtlForm model)
	{
		...
		if(tgxy_CoopAgreementSettleDtl == null || S_TheState.Deleted.equals(tgxy_CoopAgreementSettleDtl.getTheState()))
		{
		...
		properties.put("tgxy_CoopAgreementSettleDtl", tgxy_CoopAgreementSettleDtl);
