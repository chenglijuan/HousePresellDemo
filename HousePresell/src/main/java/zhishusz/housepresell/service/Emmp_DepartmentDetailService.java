...
@Service
@Transactional
public class Emmp_DepartmentDetailService
{
	@Autowired
	...
	public Properties execute(Emmp_DepartmentForm model)
	{
		...
		if(emmp_Department == null || S_TheState.Deleted.equals(emmp_Department.getTheState()))
		{
		...
		properties.put("emmp_Department", emmp_Department);
