...
@Service
@Transactional
public class Sm_CityRegionInfoDetailService
{
	@Autowired
	...
	public Properties execute(Sm_CityRegionInfoForm model)
	{
		...
		if(sm_CityRegionInfo == null || S_TheState.Deleted.equals(sm_CityRegionInfo.getTheState()))
		{
		...
		properties.put("sm_CityRegionInfo", sm_CityRegionInfo);
