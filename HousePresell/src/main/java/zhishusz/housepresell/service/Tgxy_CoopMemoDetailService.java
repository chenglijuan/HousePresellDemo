...
@Service
@Transactional
public class Tgxy_CoopMemoDetailService
{
	@Autowired
	...
	public Properties execute(Tgxy_CoopMemoForm model)
	{
		...
		if (tgxy_CoopMemo == null || S_TheState.Deleted.equals(tgxy_CoopMemo.getTheState()))
		{
		...
		properties.put("tgxy_CoopMemo", tgxy_CoopMemo);
