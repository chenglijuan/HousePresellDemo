...
/*
 * Service更新操作：监理机构 Company：ZhiShuSZ
 */
@Service
@Transactional
public class Emmp_CompanySupervisionUpdateService {
    private static final String ADD_BUSI_CODE = "020131";
    private static final String UPDATE_BUSI_CODE = "020132";
    ...
    public Properties execute(Emmp_CompanyInfoForm model) {
        ...
        if (emmp_CompanyInfo == null) {
            return MyBackInfo.fail(properties, "要修改的监理机构不存在");
        }
        ...
        Emmp_CompanyInfoTemplate companyOldTemplate =
            companyLogUitl.getCopyTemplate(emmp_CompanyInfo, orgMemberListOrg, S_CompanyType.Supervisor);
        ...
        if (S_BusiState.NoRecord.equals(emmp_CompanyInfo.getBusiState())) {
            ...
            if ("noApproval".equals(properties.getProperty(S_NormalFlag.info))) {
                ...
                Emmp_CompanyInfoTemplate companyNewTemplate =
                    companyLogUitl.getCopyTemplate(emmp_CompanyInfo, orgMemberListNew, S_CompanyType.Supervisor);
