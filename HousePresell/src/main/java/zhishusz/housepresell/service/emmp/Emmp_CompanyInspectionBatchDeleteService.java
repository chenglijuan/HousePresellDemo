...
/*
 * Service批量删除：无人机巡查机构 Company：ZhiShuSZ
 */
@Service
@Transactional
public class Emmp_CompanyInspectionBatchDeleteService {
    @Autowired
    ...
    public Properties batchDeleteExecute(Emmp_CompanyInfoForm model) {
        ...
        String busiCode = S_BusiCode.busiCode_020141;
    ...
    public Properties deleteExecute(Emmp_CompanyInfoForm model) {
        ...
        if (busiCode == null || busiCode.length() == 0) {
            busiCode = S_BusiCode.busiCode_020141;
        }
