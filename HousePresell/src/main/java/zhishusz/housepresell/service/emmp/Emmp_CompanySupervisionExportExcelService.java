...
/*
 * Service列表查询：监理机构 Company：ZhiShuSZ
 */
@Service
@Transactional(propagation = Propagation.NOT_SUPPORTED, readOnly = true)
public class Emmp_CompanySupervisionExportExcelService {
    @Autowired
    ...
    public Properties execute(Emmp_CompanyInfoForm model) {
        ...
        Properties propertiesExport =
            exportToExcelUtil.execute(emmp_CompanyInfoList, Emmp_CompanyWitnessTemplate.class, "监理机构列表信息");
