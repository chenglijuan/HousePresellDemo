...
public class Tgxy_TripleAgreementVerMngListsService
{
	@Autowired
	...
	public Properties execute(Tgxy_TripleAgreementVerMngForm model)
	{
		...
		Integer totalCount = tgxy_TripleAgreementVerMngDao.findByPage_Size(tgxy_TripleAgreementVerMngDao.getQuery_Size(tgxy_TripleAgreementVerMngDao.getBasicHQLBylike(), model));
		...
		if(totalCount > 0)
		{
			tgxy_TripleAgreementVerMngList = tgxy_TripleAgreementVerMngDao.findByPage(tgxy_TripleAgreementVerMngDao.getQuery(tgxy_TripleAgreementVerMngDao.getBasicHQLBylike(), model), pageNumber, countPerPage);
		}
		else
		{
