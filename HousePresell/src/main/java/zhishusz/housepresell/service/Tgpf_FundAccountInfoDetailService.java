...
/*
 * Service详情：推送给财务系统-设置
 * Company：ZhiShuSZ
 * */
@Service
@Transactional
public class Tgpf_FundAccountInfoDetailService
{
	@Autowired
	...
	public Properties execute(Tgpf_FundAccountInfoForm model)
	{
		...
		if(tgpf_FundAccountInfo == null || S_TheState.Deleted.equals(tgpf_FundAccountInfo.getTheState()))
		{
		...
		properties.put("tgpf_FundAccountInfo", tgpf_FundAccountInfo);
