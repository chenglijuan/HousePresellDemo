...
/*
 * Service详情：角色与机构类型对应关系
 * Company：ZhiShuSZ
 * */
@Service
@Transactional
public class Sm_Permission_RoleCompanyTypeDetailService
{
	@Autowired
	...
	public Properties execute(Sm_Permission_RoleCompanyTypeForm model)
	{
		...
		if(sm_Permission_RoleCompanyType == null || S_TheState.Deleted.equals(sm_Permission_RoleCompanyType.getTheState()))
		{
		...
		properties.put("sm_Permission_RoleCompanyType", sm_Permission_RoleCompanyType);
