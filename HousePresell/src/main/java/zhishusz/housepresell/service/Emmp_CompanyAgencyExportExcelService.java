...
import zhishusz.housepresell.util.excel.model.Emmp_CompanyAgencyTemplate;
...
public class Emmp_CompanyAgencyExportExcelService
{
	@Autowired
	...
	public Properties execute(Emmp_CompanyInfoForm model)
	{
		...
		Properties propertiesExport = exportToExcelUtil.execute(emmp_CompanyInfoList, Emmp_CompanyAgencyTemplate.class, "代理公司列表信息");
