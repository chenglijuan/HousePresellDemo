...
@Service
@Transactional
public class Sm_ApprovalProcess_RecordDetailService
{
	@Autowired
	...
	public Properties execute(Sm_ApprovalProcess_RecordForm model)
	{
		...
		if(sm_ApprovalProcess_Record == null || S_TheState.Deleted.equals(sm_ApprovalProcess_Record.getTheState()))
		{
		...
		properties.put("sm_ApprovalProcess_Record", sm_ApprovalProcess_Record);
