...
public class Emmp_CompanyInfoExportExcelService
{
	@Autowired
	...
	public Properties execute(Emmp_CompanyInfoForm model)
	{
		...
		Properties propertiesExport = exportToExcelUtil.execute(emmp_CompanyInfoList, Emmp_CompanyInfoTemplate.class, "开发企业列表信息");
