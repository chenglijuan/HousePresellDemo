...
@Service
@Transactional
public class Tg_HandleTimeLimitConfigDetailService
{
	@Autowired
	...
	public Properties execute(Tg_HandleTimeLimitConfigForm model)
	{
		...
		if(tg_HandleTimeLimitConfig == null || S_TheState.Deleted.equals(tg_HandleTimeLimitConfig.getTheState()))
		{
		...
		properties.put("tg_HandleTimeLimitConfig", tg_HandleTimeLimitConfig);
