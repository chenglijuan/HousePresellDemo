...
/*
 * Service详情：托管总资金的预测结存
 * Company：ZhiShuSZ
 * */
@Service
@Transactional
public class Tg_TotalEscrowAmountForecastDetailService
{
	@Autowired
	...
	public Properties execute(Tg_TotalEscrowAmountForecastForm model)
	{
		...
		if(tg_TotalEscrowAmountForecast == null || S_TheState.Deleted.equals(tg_TotalEscrowAmountForecast.getTheState()))
		{
		...
		properties.put("tg_TotalEscrowAmountForecast", tg_TotalEscrowAmountForecast);
