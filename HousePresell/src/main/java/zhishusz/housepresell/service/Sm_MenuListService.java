...
public class Sm_MenuListService
{
	@Autowired
...
//		model.setParentLevelNumber("0");
		List<Sm_Permission_UIResource> sm_MenuList = sm_Permission_UIResourceDao.findByPage(sm_Permission_UIResourceDao.getQuery(sm_Permission_UIResourceDao.getBasicHQL(), model));
		
		properties.put("sm_MenuList", sm_MenuList);
