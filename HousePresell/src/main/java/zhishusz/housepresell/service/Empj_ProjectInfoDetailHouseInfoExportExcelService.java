...
import zhishusz.housepresell.util.excel.model.Empj_ProjectInfoDetailHouseInfoTemplate;
...
public class Empj_ProjectInfoDetailHouseInfoExportExcelService {
    @Autowired
    ...
    public Properties execute(Empj_HouseInfoForm model) {
        ...
        Properties propertiesExport = exportToExcelUtil.execute(empj_houseInfoList, Empj_ProjectInfoDetailHouseInfoTemplate.class,
                "项目详情——户室信息");
