...
/*
 * Service添加操作：退房退款-贷款未结清
 * Company：ZhiShuSZ
 */
@Service
@Transactional
public class Tgpf_RefundInfoUnclearedAddService
{
	@Autowired
	...
	public Properties execute(Tgpf_RefundInfoForm model)
	{
		...
		// 户留存权益
		retainRightAmount = tripleAgreement
				.getTheAmountOfRetainedEquity();
	...
	/**
	 * 保存日志
	 * @param applyRefundPayoutAmount  已申请退款未拨付金额
