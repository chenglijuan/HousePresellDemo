...
@Service
@Transactional
public class Sm_ApprovalProcess_CoopAgreementSettleDetailService
{
	@Autowired
	...
	public Properties execute(Tgxy_CoopAgreementSettleForm model)
	{
		...
		Sm_User userStart = (Sm_User)sm_UserDao.findById(1L);
...
//		properties.put("tgxy_CoopAgreementSettleDtlList", tgxy_CoopAgreementSettleDtlList);
	...
	public Properties execute1(Tgxy_CoopAgreementSettleForm model)
	{
		Properties properties = new MyProperties();
