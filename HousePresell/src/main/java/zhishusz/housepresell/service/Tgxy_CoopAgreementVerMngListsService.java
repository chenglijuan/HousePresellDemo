...
public class Tgxy_CoopAgreementVerMngListsService
{
	@Autowired
	...
	public Properties execute(Tgxy_CoopAgreementVerMngForm model)
	{
		...
		Integer totalCount = tgxy_CoopAgreementVerMngDao.findByPage_Size(tgxy_CoopAgreementVerMngDao.getQuery_Size(tgxy_CoopAgreementVerMngDao.getBasicHQLBylike(), model));
		...
		if(totalCount > 0)
		{
			tgxy_CoopAgreementVerMngList = tgxy_CoopAgreementVerMngDao.findByPage(tgxy_CoopAgreementVerMngDao.getQuery(tgxy_CoopAgreementVerMngDao.getBasicHQLBylike(), model), pageNumber, countPerPage);
		}
		else
		{
