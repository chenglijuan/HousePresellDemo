...
/*
 * Service详情：申请表-项目信息变更
 * Company：ZhiShuSZ
 * */
@Service
@Transactional
public class Empj_ProjectInfo_AFDetailService
{
	@Autowired
	...
	public Properties execute(Empj_ProjectInfo_AFForm model)
	{
		...
		if(empj_ProjectInfo_AF == null || S_TheState.Deleted.equals(empj_ProjectInfo_AF.getTheState()))
		{
		...
		properties.put("empj_ProjectInfo_AF", empj_ProjectInfo_AF);
