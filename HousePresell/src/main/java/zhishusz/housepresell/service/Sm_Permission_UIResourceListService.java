...
public class Sm_Permission_UIResourceListService
{
	@Autowired
	private Sm_Permission_UIResourceDao sm_Permission_UIResourceDao;
	
	@SuppressWarnings("unchecked")
	public Properties executeUrlForSelect(Sm_Permission_UIResourceForm model)
	{
		...
		List<Sm_Permission_UIResource> sm_Permission_UIResourceList = sm_Permission_UIResourceDao.findByPage(sm_Permission_UIResourceDao.getQuery(sm_Permission_UIResourceDao.getBasicHQL(), model));
	...
	public Properties execute(Sm_Permission_UIResourceForm model)
	{
		...
		Integer totalCount = sm_Permission_UIResourceDao.findByPage_Size(sm_Permission_UIResourceDao.getQuery_Size(sm_Permission_UIResourceDao.getBasicHQL(), model));
		...
		if(totalCount > 0)
		{
			sm_Permission_UIResourceList = sm_Permission_UIResourceDao.findByPage(sm_Permission_UIResourceDao.getQuery(sm_Permission_UIResourceDao.getBasicHQL(), model), pageNumber, countPerPage);
		}
		else
		{
