...
@Service
@Transactional
public class Sm_FastNavigateDetailService
{
	@Autowired
	...
	public Properties execute(Sm_FastNavigateForm model)
	{
		...
		if(sm_FastNavigate == null || S_TheState.Deleted.equals(sm_FastNavigate.getTheState()))
		{
		...
		properties.put("sm_FastNavigate", sm_FastNavigate);
