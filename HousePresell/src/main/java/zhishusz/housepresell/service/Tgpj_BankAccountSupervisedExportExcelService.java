...
import zhishusz.housepresell.util.excel.model.Tgpj_BankAccountSupervisedTemplate;
...
public class Tgpj_BankAccountSupervisedExportExcelService
{
	@Autowired
	...
	public Properties execute(Tgpj_BankAccountSupervisedForm model)
	{
		...
		Properties propertiesExport = exportToExcelUtil.execute(tgpj_BankAccountSupervised, Tgpj_BankAccountSupervisedTemplate.class, "监管账户列表信息");
