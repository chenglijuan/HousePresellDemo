...
public class HandlerPicAndSubmitBakService {
	...
	public void handlerBakExecute() {

		System.out.println("handlerExecuteBak定时任务开始" + System.currentTimeMillis());
		...
		if (null == baseParameter) {
			System.out.println("handlerExecuteBak-未查询到baseParameter水印位置" + System.currentTimeMillis());
			return;
		}
		...
		if (null == baseParameter2) {
			System.out.println("handlerExecuteBak-未查询到baseParameter2限定高度" + System.currentTimeMillis());
			return;
		}
		...
		if (null == baseParameter3) {
			System.out.println("handlerExecuteBak-未查询到baseParameter3限定宽度" + System.currentTimeMillis());
			return;
		}
		...
		if (null == baseParameter0) {
			System.out.println("handlerExecuteBak-未查询到baseParameter0推送网站地址" + System.currentTimeMillis());
			return;
		}
		...
		for (Empj_ProjProgForcast_Manage manage : listManage) {
			...
			System.out.println("handlerExecuteBak楼幢：" + dtl.getBuildCode() + "START" + System.currentTimeMillis());
			...
			System.out.println("handlerExecuteBak楼幢：" + dtl.getBuildCode() + "END" + System.currentTimeMillis());
