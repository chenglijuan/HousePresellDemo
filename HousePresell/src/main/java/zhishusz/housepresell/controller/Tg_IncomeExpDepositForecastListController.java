...
import zhishusz.housepresell.service.Tg_IncomeExpDepositForecastListService;
 ...
 * */
@Controller
public class Tg_IncomeExpDepositForecastListController extends BaseController
{
	@Autowired
	private Tg_IncomeExpDepositForecastListService service;
	@Autowired
	private Tg_IncomeExpDepositForecastRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Tg_IncomeExpDepositForecastList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
