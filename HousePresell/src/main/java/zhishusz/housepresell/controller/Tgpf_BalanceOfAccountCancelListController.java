...
import zhishusz.housepresell.service.Tgpf_BalanceOfAccountCancelListService;
import zhishusz.housepresell.util.JsonUtil;
import zhishusz.housepresell.util.MyProperties;
import zhishusz.housepresell.util.rebuild.Tgpf_BalanceOfAccountRebuild;
/*
 * Controller列表查询：网银对账(撤销)
 * Company：ZhiShuSZ
 * */
@Controller
public class Tgpf_BalanceOfAccountCancelListController
{
	@Autowired
	private Tgpf_BalanceOfAccountCancelListService service;
	@Autowired
	private Tgpf_BalanceOfAccountRebuild rebuild;
	
	@RequestMapping(value="/Tgpf_BalanceOfAccountCancelList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
