...
import zhishusz.housepresell.service.Sm_Permission_RangeAuthorizationForZTEditService;
...
/*
 * Controller列表查询：正泰机构范围授权编辑
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_Permission_RangeAuthorizationForZTEditController extends BaseController
{
	@Autowired
	private Sm_Permission_RangeAuthorizationForZTEditService service;
	@Autowired
	private Sm_Permission_RangeAuthorizationRebuild rebuild;
	
	@RequestMapping(value="/Sm_Permission_RangeAuthorizationForZTEdit",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RangeAuthorizationForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RangeAuthorizationForZTEdit", model, properties, jsonStr);
