 ...
 */
@Controller
public class Tgxy_EscrowAgreementDetailController extends BaseController
{
	@Autowired
	private Tgxy_EscrowAgreementDetailService service;
	@Autowired
	...
	@RequestMapping(value = "/Tgxy_EscrowAgreementDetail", produces = "text/html;charset=UTF-8", method = {
	...
	public String execute(@ModelAttribute Tgxy_EscrowAgreementForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tgxy_EscrowAgreementDetail", model, properties, jsonStr);
