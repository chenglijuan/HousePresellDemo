...
import zhishusz.housepresell.service.Tgxy_TripleAgreementReview_ViewExcelService;
 ...
 * */
@Controller
public class Tgxy_TripleAgreementReview_ViewExportExcelController extends BaseController
{
	@Autowired
	private Tgxy_TripleAgreementReview_ViewExcelService service;
//	@Autowired
//	private Tg_RiskRoutineCheckInfoRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Tgxy_TripleAgreementReview_ViewExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
