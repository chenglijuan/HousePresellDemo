 ...
 * */
@Controller
public class Sm_Permission_Role_DetailForRoleUIController extends BaseController
{
	@Autowired
	...
	@RequestMapping(value="/Sm_Permission_Role_DetailForRoleUI",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RoleForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_Role_DetailForRoleUI", model, properties, jsonStr);
