...
import zhishusz.housepresell.service.Sm_ApprovalProcess_TripleAgreementVerMngDetailService;
...
/*
 * Controller详情：审批流-三方协议版本管理
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_ApprovalProcess_TripleAgreementVerMngDetailController extends BaseController{

	@Autowired
	private Sm_ApprovalProcess_TripleAgreementVerMngDetailService service;
	@Autowired
	...
	@RequestMapping(value = "/Sm_ApprovalProcess_TripleAgreementVerMngDetail", produces = "text/html;charset=UTF-8", method = {
	...
	public String execute(@ModelAttribute Tgxy_TripleAgreementVerMngForm model, HttpServletRequest request)
	{
		...
		{
			properties.put("Tgxy_TripleAgreementVerMng",
					rebuild.getSimpleInfo2((Tgxy_TripleAgreementVerMng) (properties.get("tgxy_TripleAgreementVerMng"))));
