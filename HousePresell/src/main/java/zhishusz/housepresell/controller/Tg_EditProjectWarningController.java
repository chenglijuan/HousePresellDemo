 ...
 */
@Controller
public class Tg_EditProjectWarningController extends BaseController
{

	@Autowired
	private SendWarningMessageService service;
	
	@RequestMapping(value="/Tg_EditProjectWarning",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tg_EarlyWarningFrom model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tg_EditProjectWarning", model, properties, jsonStr);
