...
import zhishusz.housepresell.service.Emmp_CompanyWitnessExportExcelService;
...
@Controller
@EnableCaching
public class Emmp_CompanyWitnessExportExcelController extends BaseController
{
	@Autowired
	private Emmp_CompanyWitnessExportExcelService service;
	@Autowired
	private Emmp_CompanyInfoRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Emmp_CompanyWitnessExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
