 ...
 * */
@Controller
public class Tgxy_TripleAgreementVerMngAddsController extends BaseController
{
	@Autowired
	private Tgxy_TripleAgreementVerMngAddsService service;
	
	@RequestMapping(value="/Tgxy_TripleAgreementVerMngAdds",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tgxy_TripleAgreementVerMngForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tgxy_TripleAgreementVerMngAdds", model, properties, jsonStr);
