...
import zhishusz.housepresell.service.Sm_Permission_RoleUIDetailService;
...
/*
 * Controller详情：角色与UI权限对应关系
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_Permission_RoleUIDetailController extends BaseController
{
	@Autowired
	private Sm_Permission_RoleUIDetailService service;
	@Autowired
	private Sm_Permission_RoleRebuild rebuild;
	
	@RequestMapping(value="/Sm_Permission_RoleUIDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RoleUIForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RoleUIDetail", model, properties, jsonStr);
