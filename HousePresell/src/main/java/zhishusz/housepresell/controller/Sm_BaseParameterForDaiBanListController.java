...
import zhishusz.housepresell.service.Sm_BaseParameterForDaiBanListService;
 ...
 * */
@Controller
public class Sm_BaseParameterForDaiBanListController extends BaseController
{
	@Autowired
	private Sm_BaseParameterForDaiBanListService service;
	@Autowired
	private Sm_BaseParameterRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Sm_BaseParameterForDaiBanList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
