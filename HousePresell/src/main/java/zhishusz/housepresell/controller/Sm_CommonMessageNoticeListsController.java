...
import zhishusz.housepresell.service.Sm_CommonMessageNoticeListsService;
 ...
 * */
@Controller
public class Sm_CommonMessageNoticeListsController extends BaseController
{
	@Autowired
	private Sm_CommonMessageNoticeListsService service;
	@Autowired
	private Sm_ApprovalProcess_WorkflowRebuild rebuild;
	
	@RequestMapping(value="/Sm_CommonMessageNoticeLists",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
