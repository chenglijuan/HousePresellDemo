 ...
 * */
@Controller
public class Sm_Permission_UIResourceListController extends BaseController
{
	@Autowired
	private Sm_Permission_UIResourceListService service;
	@Autowired
	private Sm_Permission_UIResourceRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Sm_Permission_UIResourceList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_UIResourceForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_UIResourceList", model, properties, jsonStr);
