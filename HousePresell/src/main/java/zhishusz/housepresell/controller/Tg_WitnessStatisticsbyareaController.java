 ...
 * */
@Controller
public class Tg_WitnessStatisticsbyareaController extends BaseController
{
	@Autowired
	private Tg_WitnessStatisticsbyareaService service;
		
	@RequestMapping(value="/Tg_WitnessStatisticsbyarea",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tg_WitnessStatisticsForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tg_WitnessStatisticsbyarea", model, properties, jsonStr);
