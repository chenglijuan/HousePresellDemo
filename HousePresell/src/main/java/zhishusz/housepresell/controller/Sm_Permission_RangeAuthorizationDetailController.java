...
import zhishusz.housepresell.service.Sm_Permission_RangeAuthorizationDetailService;
...
/*
 * Controller列表查询：范围授权详情
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_Permission_RangeAuthorizationDetailController extends BaseController
{
	@Autowired
	private Sm_Permission_RangeAuthorizationDetailService service;
	@Autowired
	private Sm_Permission_RangeAuthorizationRebuild rebuild;
	@Autowired
	private Sm_CityRegionInfoRebuild sm_CityRegionInfoRebuild;
	
	@RequestMapping(value="/Sm_Permission_RangeAuthorizationDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RangeAuthorizationForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RangeAuthorizationDetail", model, properties, jsonStr);
