...
import zhishusz.housepresell.service.Tgpf_SpecialFundAppropriated_AFDetailService;
 ...
 * */
@Controller
public class Tgpf_SpecialFundAppropriated_AFDetailController extends BaseController
{
	@Autowired
	private Tgpf_SpecialFundAppropriated_AFDetailService service;
	@Autowired
	private Tgpf_SpecialFundAppropriated_AFRebuild rebuild;
	@Autowired
	private Sm_AttachmentCfgRebuild rebuild4;
	
	@RequestMapping(value="/Tgpf_SpecialFundAppropriated_AFDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
