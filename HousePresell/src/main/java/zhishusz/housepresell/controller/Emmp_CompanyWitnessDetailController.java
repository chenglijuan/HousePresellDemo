...
import zhishusz.housepresell.service.Emmp_CompanyWitnessDetailService;
...
@Controller
@EnableCaching
public class Emmp_CompanyWitnessDetailController extends BaseController
{
	@Autowired
	private Emmp_CompanyWitnessDetailService service;
	@Autowired
	...
	@RequestMapping(value="/Emmp_CompanyWitnessDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
//	@Cacheable(value="Emmp_CompanyWitness", key="'Emmp_CompanyInfoId'+#model.getTableId()")
		...
		if(MyBackInfo.isSuccess(properties))
		{
			...
			else
			{
				...
				properties.put("emmp_OrgMemberList", rebuild2.getListForApproval((List)(properties.get(
						...
						S_BusiState.NoRecord.equals(model.getBusiState()) ? "020106" : "020107", model.getBusiState()));
			}
		}
		
		String jsonStr = new JsonUtil().propertiesToJson(properties);
		
		super.writeOperateHistory("Emmp_CompanyWitnessDetail", model, properties, jsonStr);
