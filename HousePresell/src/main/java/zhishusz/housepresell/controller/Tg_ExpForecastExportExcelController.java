...
import zhishusz.housepresell.service.Tg_ExpForecastExportExcelService;
 ...
 * */
@Controller
public class Tg_ExpForecastExportExcelController extends BaseController
{
	@Autowired
	private Tg_ExpForecastExportExcelService service;
	@Autowired
	private Tg_ExpForecastRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Tg_ExpForecastExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
