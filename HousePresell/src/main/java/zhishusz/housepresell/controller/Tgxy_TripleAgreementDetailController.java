...
import zhishusz.housepresell.service.Tgxy_TripleAgreementDetailService;
 ...
 */
@Controller
public class Tgxy_TripleAgreementDetailController extends BaseController
{
	@Autowired
	private Tgxy_TripleAgreementDetailService service;
	@Autowired
	...
	@RequestMapping(value = "/Tgxy_TripleAgreementDetail", produces = "text/html;charset=UTF-8", method = {
	...
	public String execute(@ModelAttribute Tgxy_TripleAgreementForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tgxy_TripleAgreementDetail", model, properties, jsonStr);
