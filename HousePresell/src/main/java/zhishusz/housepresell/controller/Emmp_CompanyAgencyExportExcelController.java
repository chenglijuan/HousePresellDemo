...
import zhishusz.housepresell.service.Emmp_CompanyAgencyExportExcelService;
...
@Controller
@EnableCaching
public class Emmp_CompanyAgencyExportExcelController extends BaseController
{
	@Autowired
	private Emmp_CompanyAgencyExportExcelService service;
	@Autowired
	private Emmp_CompanyInfoRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Emmp_CompanyAgencyExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
