...
import zhishusz.housepresell.service.Sm_Permission_RangeAuthorizationForZTAddService;
 ...
 * */
@Controller
public class Sm_Permission_RangeAuthorizationForZTAddController extends BaseController
{
	@Autowired
	private Sm_Permission_RangeAuthorizationForZTAddService service;
	@Autowired
	private Sm_Permission_RangeAuthorizationRebuild rebuild;
	
	@RequestMapping(value="/Sm_Permission_RangeAuthorizationForZTAdd",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RangeAuthorizationForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RangeAuthorizationForZTAdd", model, properties, jsonStr);
