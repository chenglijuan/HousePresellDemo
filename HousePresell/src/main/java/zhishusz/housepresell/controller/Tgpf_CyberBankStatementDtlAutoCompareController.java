...
import zhishusz.housepresell.service.Tgpf_CyberBankStatementDtlAutoCompareService;
 ...
 * */
@Controller
public class Tgpf_CyberBankStatementDtlAutoCompareController
{
	@Autowired
	private Tgpf_CyberBankStatementDtlAutoCompareService service;
	
	@RequestMapping(value="/tgpf_CyberBankStatementDtlAutoCompare",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
