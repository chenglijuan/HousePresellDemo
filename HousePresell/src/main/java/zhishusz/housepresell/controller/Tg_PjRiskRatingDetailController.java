...
import zhishusz.housepresell.service.Tg_PjRiskRatingDetailService;
 ...
 * */
@Controller
public class Tg_PjRiskRatingDetailController extends BaseController
{
	@Autowired
	private Tg_PjRiskRatingDetailService service;
	@Autowired
	private Tg_PjRiskRatingRebuild rebuild;
	@Autowired
	private Sm_AttachmentCfgRebuild rebuild3;
	
	@RequestMapping(value="/Tg_PjRiskRatingDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tg_PjRiskRatingForm model, HttpServletRequest request)
	{
		...
		{
			properties.put("tg_PjRiskRating", rebuild.getDetail((Tg_PjRiskRating)(properties.get("tg_PjRiskRating"))));
		...
		super.writeOperateHistory("Tg_PjRiskRatingDetail", model, properties, jsonStr);
