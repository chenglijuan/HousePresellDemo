 ...
 * */
@Controller
public class Sm_FastNavigateListsController extends BaseController
{
	@Autowired
	private Sm_FastNavigateListsService service;
	@Autowired
	private Sm_FastNavigateRebuild rebuild;
	@RequestMapping(value="/Sm_FastNavigateLists",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_FastNavigateForm model, HttpServletRequest request)
	{
		...
		{
			properties.put("sm_FastNavigateList", rebuild.getFastNavigateList((List)(properties.get("sm_FastNavigateList"))));
		}
