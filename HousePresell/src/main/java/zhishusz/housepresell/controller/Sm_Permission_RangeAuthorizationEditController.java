...
import zhishusz.housepresell.service.Sm_Permission_RangeAuthorizationEditService;
...
/*
 * Controller列表查询：范围授权编辑
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_Permission_RangeAuthorizationEditController extends BaseController
{
	@Autowired
	private Sm_Permission_RangeAuthorizationEditService service;
	@Autowired
	private Sm_Permission_RangeAuthorizationRebuild rebuild;
	
	@RequestMapping(value="/Sm_Permission_RangeAuthorizationEdit",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RangeAuthorizationForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RangeAuthorizationEdit", model, properties, jsonStr);
