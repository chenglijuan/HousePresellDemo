 ...
 * */
@Controller
public class Empj_BuildingInfoListController extends BaseController
{
	@Autowired
	...
	@RequestMapping(value="/Empj_BuildingInfoList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
