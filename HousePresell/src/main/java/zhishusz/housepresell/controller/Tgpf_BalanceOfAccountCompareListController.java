 ...
 * */
@Controller
public class Tgpf_BalanceOfAccountCompareListController
{
	@Autowired
	private Tgpf_BalanceOfAccountCompareListService service;
	@Autowired
	private Tgpf_BalanceOfAccountRebuild rebuild;
	
	@RequestMapping(value="/Tgpf_BalanceOfAccountCompareList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
