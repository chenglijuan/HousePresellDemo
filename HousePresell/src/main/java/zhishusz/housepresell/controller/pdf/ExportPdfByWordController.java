...
/*
 * Controller  导出操作：Word 转 PDF
 * Company：ZhiShuSZ
 * */
@Controller
public class ExportPdfByWordController extends BaseController
{

	@Autowired
	private ExportPdfByWordService service;
	
	@RequestMapping(value="/exportPDFByWord",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	...
	/*model.setSourceId("66");
		...
		super.writeOperateHistory("exportPDFByWord", model, properties, jsonStr);
