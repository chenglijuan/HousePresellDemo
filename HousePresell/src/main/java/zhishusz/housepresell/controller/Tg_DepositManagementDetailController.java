...
import zhishusz.housepresell.service.Tg_DepositManagementDetailService;
 ...
 * */
@Controller
public class Tg_DepositManagementDetailController extends BaseController
{
	@Autowired
	private Tg_DepositManagementDetailService service;
	@Autowired
	private Tg_DepositManagementRebuild rebuild;
	
	@RequestMapping(value="/Tg_DepositManagementDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tg_DepositManagementForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tg_DepositManagementDetail", model, properties, jsonStr);
