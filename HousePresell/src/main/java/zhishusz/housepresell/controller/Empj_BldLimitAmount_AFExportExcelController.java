...
import zhishusz.housepresell.service.Empj_BldLimitAmount_AFExportExcelService;
...
@Controller
@EnableCaching
public class Empj_BldLimitAmount_AFExportExcelController extends BaseController
{
	@Autowired
	private Empj_BldLimitAmount_AFExportExcelService service;
	@Autowired
	private Empj_BldLimitAmount_AFRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Empj_BldLimitAmount_AFExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	@Cacheable(value="Empj_BldLimitAmount_AF", key="#model.getMD5()")
