...
import zhishusz.housepresell.service.Tgxy_CoopAgreementDetailService;
...
@Controller
@EnableCaching
public class Tgxy_CoopAgreementDetailController extends BaseController
{
	@Autowired
	private Tgxy_CoopAgreementDetailService service;
	@Autowired
	...
	@RequestMapping(value = "/Tgxy_CoopAgreementDetail", produces = "text/html;charset=UTF-8", method = {
	...
	public String execute(@ModelAttribute Tgxy_CoopAgreementForm model, HttpServletRequest request)
	{
		...
		{
			properties.put("tgxy_CoopAgreement",
					rebuild.execute((Tgxy_CoopAgreement) (properties.get("tgxy_CoopAgreement"))));
		...
		super.writeOperateHistory("Tgxy_CoopAgreementDetail", model, properties, jsonStr);
