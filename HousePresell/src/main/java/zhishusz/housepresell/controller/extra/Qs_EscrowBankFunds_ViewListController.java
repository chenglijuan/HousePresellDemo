...
/*
 * Controller列表查询：贷款银行资金明细表
 * Company：ZhiShuSZ
 * */
@Controller
public class Qs_EscrowBankFunds_ViewListController extends BaseController
{
	@Autowired
	private Qs_EscrowBankFunds_ViewListService service;
	
	@RequestMapping(value="/Qs_EscrowBankFunds_ViewList",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
...
//		super.writeOperateHistory("Qs_EscrowBankFunds_ViewList", model, properties, jsonStr);
