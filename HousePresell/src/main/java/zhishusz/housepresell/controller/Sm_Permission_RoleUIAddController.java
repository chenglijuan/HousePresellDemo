...
/*
 * Controller添加操作：角色与UI权限对应关系
 * Company：ZhiShuSZ
 * */
@Controller
public class Sm_Permission_RoleUIAddController extends BaseController
{
	@Autowired
	...
	@RequestMapping(value="/Sm_Permission_RoleUIAdd",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_Permission_RoleUIForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_Permission_RoleUIAdd", model, properties, jsonStr);
