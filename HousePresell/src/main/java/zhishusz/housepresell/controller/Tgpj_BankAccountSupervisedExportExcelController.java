...
import zhishusz.housepresell.service.Tgpj_BankAccountSupervisedExportExcelService;
...
@Controller
@EnableCaching
public class Tgpj_BankAccountSupervisedExportExcelController extends BaseController
{
	@Autowired
	private Tgpj_BankAccountSupervisedExportExcelService service;
	@Autowired
	private Tgpj_BankAccountSupervisedRebuild rebuild;

	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Tgpj_BankAccountSupervisedExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
