...
import zhishusz.housepresell.service.Sm_ApprovalProcess_TripleAgreementDetailService;
 ...
 */
@Controller
public class Sm_ApprovalProcess_TripleAgreementDetailController extends BaseController
{
	@Autowired
	private Sm_ApprovalProcess_TripleAgreementDetailService service;
	@Autowired
	...
	@RequestMapping(value = "/Sm_ApprovalProcess_TripleAgreementDetail", produces = "text/html;charset=UTF-8", method = {
	...
	public String execute(@ModelAttribute Tgxy_TripleAgreementForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_ApprovalProcess_TripleAgreementDetail", model, properties, jsonStr);
