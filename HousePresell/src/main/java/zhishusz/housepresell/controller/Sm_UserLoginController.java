...
import zhishusz.housepresell.service.Sm_UserLoginPreGetMsgService;
 ...
 */
@Controller
public class Sm_UserLoginController extends BaseController
{
	@Autowired
	private Sm_UserLoginPreGetMsgService service;
	@Autowired
	private Sm_UserRebuild rebuild;
	
	@RequestMapping(value="/Sm_UserLogin",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Sm_UserForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Sm_UserLogin", model, properties, jsonStr);
