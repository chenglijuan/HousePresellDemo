...
public class Tg_PjRiskLetterForm extends NormalActionForm
{
	...
	@Getter @Setter
	private String deliveryCompany;//主送单位
	@Getter @Setter
	...
	@Getter @Setter
	private String letterDateBegin;//风险函发布日期yyyy-MM-dd
	@Getter @Setter
	private String letterDateEnd;//风险函发布日期yyyy-MM-dd
	
	@Getter @Setter
	private String tg_PjRiskLetterReceiverList;//风险函发布日期yyyy-MM-dd
