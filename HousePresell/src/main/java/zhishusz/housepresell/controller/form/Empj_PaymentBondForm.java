...
public class Empj_PaymentBondForm extends NormalActionForm {

    private static final long serialVersionUID = 7028110895715623370L;
    @Getter
    @Setter
    ...
    @Getter
    @Setter
    @IFieldAnnotation(remark = "开发企业Id ")
    ...
    @Getter
    @Setter
    @IFieldAnnotation(remark = "保证机构(1-银行 2-保险公 3-担保公司 )")
    ...
    @Getter
    @Setter
    private List<Empj_PaymentBondChildForm> empj_PaymentBondChildList;
