...
/*
 * Form表单：申请表-项目托管终止（审批）-明细表
 * Company：ZhiShuSZ
 * */
@ToString(callSuper=true)
public class Empj_BldEscrowCompleted_DtlForm extends NormalActionForm
{
	private static final long serialVersionUID = 7067087807432151484L;
	...
	@Getter @Setter
	private String eCodeOfMainTable;//申请单号-冗余字段
	@Getter @Setter
	private Empj_BldEscrowCompleted mainTable;//关联申请主表
	@Getter @Setter
	private Long mainTableId;//关联申请主表-Id
	@Getter @Setter
