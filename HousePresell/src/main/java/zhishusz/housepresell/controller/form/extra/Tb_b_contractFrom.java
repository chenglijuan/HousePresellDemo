 ...
 * 中间库合同From
 * 
 * @ClassName: Tb_b_ontractFrom
 * @Description:TODO
 * @author: xushizhong
 * @date: 2018年9月2日 下午8:44:38
 * @version V1.0
 *
 */
@ToString(callSuper = true)
public class Tb_b_contractFrom extends NormalActionForm {
	private static final long serialVersionUID = -2208225035643447785L;
