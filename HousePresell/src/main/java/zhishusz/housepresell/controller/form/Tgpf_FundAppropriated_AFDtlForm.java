...
public class Tgpf_FundAppropriated_AFDtlForm extends NormalActionForm
{
	...
	@Getter @Setter
	private Long selectId;//关联监管账号-Id
	...
	@Getter @Setter
	private String payoutStatement;//主表拨付状态
	@Getter @Setter
	private Tgpj_BankAccountSupervisedForm[] tgpj_bankAccountSupervisedForm;//监管账号
