...
import zhishusz.housepresell.service.Emmp_CompanyWitnessAddService;
...
@Controller
@EnableCaching
public class Emmp_CompanyWitnessAddController extends BaseController
{
	@Autowired
	private Emmp_CompanyWitnessAddService service;
	@Autowired
	private Emmp_CompanyInfoRebuild rebuild;
	
	@RequestMapping(value="/Emmp_CompanyWitnessAdd",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
//	@CacheEvict(value="Emmp_CompanyWitness", allEntries=true)
	public String execute(@RequestBody Emmp_CompanyInfoForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Emmp_CompanyWitnessAdd", model, properties, jsonStr);
