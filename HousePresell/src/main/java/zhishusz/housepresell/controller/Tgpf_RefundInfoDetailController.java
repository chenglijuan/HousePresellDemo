...
import zhishusz.housepresell.service.Tgpf_RefundInfoDetailService;
...
/*
 * Controller详情：退房退款-贷款已结清
 * Company：ZhiShuSZ
 * */
@Controller
public class Tgpf_RefundInfoDetailController extends BaseController
{
	@Autowired
	private Tgpf_RefundInfoDetailService service;
	@Autowired
	...
	@RequestMapping(value="/Tgpf_RefundInfoDetail",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	public String execute(@ModelAttribute Tgpf_RefundInfoForm model, HttpServletRequest request)
	{
		...
		super.writeOperateHistory("Tgpf_RefundInfoDetail", model, properties, jsonStr);
