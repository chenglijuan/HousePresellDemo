...
import zhishusz.housepresell.service.emmp.Emmp_CompanyInspectionDetailService;
...
/*
 * Controller详情：无人机巡查机构 Company：ZhiShuSZ
 */
@Controller
public class Emmp_CompanyInspectionDetailController extends BaseController {
    @Autowired
    private Emmp_CompanyInspectionDetailService service;
    @Autowired
    ...
    @RequestMapping(value = "/Emmp_CompanyInspectionDetail", produces = "text/html;charset=UTF-8",
            ...
            if ("详情".equals(model.getReqSource())) {
                ...
                properties.put("emmp_OrgMemberList",
                    rebuild2.getListForApproval((List)(properties.get("emmp_OrgMemberList")), model.getTableId(),
                        S_BusiState.NoRecord.equals(model.getBusiState()) ? "020141" : "020142", model.getBusiState()));
            }
        }

        String jsonStr = new JsonUtil().propertiesToJson(properties);

        super.writeOperateHistory("Emmp_CompanyInspectionDetail", model, properties, jsonStr);
