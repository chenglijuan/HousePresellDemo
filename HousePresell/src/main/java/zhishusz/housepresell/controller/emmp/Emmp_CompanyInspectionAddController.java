...
import zhishusz.housepresell.service.emmp.Emmp_CompanyInspectionAddService;
...
/*
 * Controller添加操作：无人机巡查机构 Company：ZhiShuSZ
 */
@Controller
public class Emmp_CompanyInspectionAddController extends BaseController {
    @Autowired
    private Emmp_CompanyInspectionAddService service;
    @Autowired
    private Emmp_CompanyInfoRebuild rebuild;

    @RequestMapping(value = "/Emmp_CompanyInspectionAdd", produces = "text/html;charset=UTF-8",
    ...
    public String execute(@RequestBody Emmp_CompanyInfoForm model, HttpServletRequest request) {
        ...
        super.writeOperateHistory("Emmp_CompanyInspectionAdd", model, properties, jsonStr);
