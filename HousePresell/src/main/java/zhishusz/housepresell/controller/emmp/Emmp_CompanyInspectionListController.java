...
import zhishusz.housepresell.service.emmp.Emmp_CompanyInspectionListService;
...
/*
 * Controller列表查询：无人机巡查机构 Company：ZhiShuSZ
 */
@Controller
public class Emmp_CompanyInspectionListController extends BaseController {
    @Autowired
    private Emmp_CompanyInspectionListService service;
    @Autowired
    private Emmp_CompanyInfoRebuild rebuild;

    @SuppressWarnings({"unchecked", "rawtypes"})
    @RequestMapping(value = "/Emmp_CompanyInspectionList", produces = "text/html;charset=UTF-8",
    ...
    public String execute(@ModelAttribute Emmp_CompanyInfoForm model, HttpServletRequest request) {
        ...
        super.writeOperateHistory("Emmp_CompanyInspectionList", model, properties, jsonStr);
