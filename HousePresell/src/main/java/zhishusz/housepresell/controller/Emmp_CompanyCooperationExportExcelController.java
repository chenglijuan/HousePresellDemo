...
import zhishusz.housepresell.service.Emmp_CompanyCooperationExportExcelService;
...
@Controller
@EnableCaching
public class Emmp_CompanyCooperationExportExcelController extends BaseController
{
	@Autowired
	private Emmp_CompanyCooperationExportExcelService service;
	@Autowired
	private Emmp_CompanyInfoRebuild rebuild;
	
	@SuppressWarnings({"rawtypes", "unchecked"})
	@RequestMapping(value="/Emmp_CompanyCooperationExportExcel",produces="text/html;charset=UTF-8",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
