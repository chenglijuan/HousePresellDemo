 ...
 * */
@Repository
public class Tgxy_BankAccountEscrowedViewDao extends BaseDao<Tgxy_BankAccountEscrowedView> {
    public String getBasicHQL() {
        return "from Tgxy_BankAccountEscrowedView where 1=1"
