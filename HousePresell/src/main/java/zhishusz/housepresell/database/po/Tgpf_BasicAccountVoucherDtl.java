...
public class Tgpf_BasicAccountVoucherDtl implements Serializable
{
    
    private static final long serialVersionUID = -5142986931666550902L;
	...
	private String sendState;//凭证状态【自动写入枚举：0-未推送、1-已推送】
	...
	@Getter @Setter @IFieldAnnotation(remark="是否拆分（0-否 1-是）")
    private String isSplit;
	
	@Getter @Setter @IFieldAnnotation(remark="基本户信息")
