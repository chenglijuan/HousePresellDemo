 ...
 * TODO：PO未完待续
 */
@ITypeAnnotation(remark="申请表-项目信息变更")
public class Empj_ProjectInfo_AF implements Serializable,IApprovable
{
	private static final long serialVersionUID = 7564157412398483714L;
