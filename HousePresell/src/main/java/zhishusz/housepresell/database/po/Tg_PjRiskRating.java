 ...
 * 对象名称：项目风险评级
 */
@ITypeAnnotation(remark="项目风险评级")
public class Tg_PjRiskRating implements Serializable
{
	private static final long serialVersionUID = 4739673773948736384L;
	...
	@Getter @Setter @IFieldAnnotation(remark="评级日期yyyy-MM-dd")
	private String operateDate;
	
	@Getter @Setter @IFieldAnnotation(remark="评级级别")
