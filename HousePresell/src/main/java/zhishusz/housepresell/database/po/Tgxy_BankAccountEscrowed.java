...
public class Tgxy_BankAccountEscrowed implements Serializable
{
	private static final long serialVersionUID = -1488084750276674872L;
	...
	@Getter @Setter @IFieldAnnotation(remark="活期余额-合并")
	private Double currentBalanceView;

	@Getter @Setter @IFieldAnnotation(remark="总资金沉淀-合并")
	private Double totalFundsRatioView;
