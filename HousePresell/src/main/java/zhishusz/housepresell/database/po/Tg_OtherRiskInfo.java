 ...
 * 对象名称：其他风险信息
 */
@ITypeAnnotation(remark="其他风险信息")
public class Tg_OtherRiskInfo implements Serializable
{
	private static final long serialVersionUID = 7301623081918201630L;
	...
	@Getter @Setter @IFieldAnnotation(remark="风险输入日期yyyyMMdd")
	private String riskInputDate;
	
	@Getter @Setter @IFieldAnnotation(remark="其他风险信息")
	private String riskInfo;
	
	@Getter @Setter @IFieldAnnotation(remark="是否录用")
