...
/**
 * 统计报表-楼幢账户表
 * @ClassName:  Qs_BuildingAccount_View   
 * @Description:TODO   
 * @author: xushizhong 
 * @date:   2018年9月5日 下午3:53:29   
 * @version V1.0 
 *
 */
@ITypeAnnotation(remark="楼幢账户表")
public class Qs_BuildingAccount_View implements Serializable
{
	...
	@Getter @Setter @IFieldAnnotation(remark="支付保证金额")
	private Double zfbzPrice;
	
	@Getter @Setter @IFieldAnnotation(remark="现金受限金额")
