...
@Transactional
public class PanYunDingdingSignWebServiceImplbak implements PanYunDingdingSignWebService {

    private static final Logger LOGGER = LoggerFactory.getLogger(PanYunDingdingSignWebServiceImplbak.class);
