...
@Transactional
public class PanYunDingdingWebServiceImpl implements PanYunDingdingWebService {

	private static final Logger LOGGER = LoggerFactory.getLogger(PanYunDingdingWebServiceImpl.class);
