 ...
 **/
@Service
public class PanYunDingDingPushDataServiceImpl implements PanYunDingDingPushDataService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PanYunDingDingPushDataServiceImpl.class);
    ...
    public boolean pushSupervisorCompanyData(Empj_BldLimitAmount bldLimitAmount) {
        ...
        String resultOne = SoapUtil.splicingMessage(namespace, url, namespace + "SupervisionCompany", "SupervisionCompany", oneParams);
    ...
    public boolean pushBuildingData(Empj_BldLimitAmount bldLimitAmount) {
        ...
        for (Empj_BldLimitAmount_Dtl dtl : bldLimitAmount.getDtlList()) {
            ...
            if ("1".equals(dtl.getApprovalResult())) {
                ...
                String result = SoapUtil.splicingMessage(namespace, url, namespace + "BuildingInfo", "BuildingInfo", params);
                System.out.println("result : " + result);
    ...
    public void pushChangeNodeData(Empj_BldLimitAmount bldLimitAmount) {
        ...
        for (Empj_BldLimitAmount_Dtl dtl : bldLimitAmount.getDtlList()) {
            ...
            if ("1".equals(dtl.getApprovalResult())) {
                ...
                String result = SoapUtil.splicingMessage(namespace, url, namespace + "ChangeNode", "ChangeNode", params);
                System.out.println("result : " + result);
                sb.append("result : " + result + "/n");
