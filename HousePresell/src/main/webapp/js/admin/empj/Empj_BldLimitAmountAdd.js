     	        ...
     	        else 
     	        {
     	        	  if(buttonType == '2')
     	              {
     	              	if(jsonObj.signatureMap != undefined&&jsonObj.signatureMap != null)
     	  					...
     	  					console.log("签章关键字：" + signatureKeyword);
...
//		 	  											enterNewTabCloseCurrent(jsonObj.tableId,"受限额度变更详情","empj/Empj_BldLimitAmountDetail.shtml");
														...
														else
														{
															...
															new ServerInterfaceJsonBody(baseInfo.addInterface).execute(model, function(jsonObj3) {
													            ...
													            {
													            	generalSuccessModal();
													            	enterNewTabCloseCurrent(jsonObj3.tableId,"受限额度变更详情","empj/Empj_BldLimitAmountDetail.shtml");
													            }
															});
														}
     	  						...
     	  						$(".xszModel").modal('hide');
     	  						generalSuccessModal();
     	  						enterNewTabCloseCurrent(jsonObj.tableId,"进度节点变更详情","empj/Empj_BldLimitAmountDetail.shtml");
     	  					}
     	  				}else{
     	  					$(".xszModel").modal('hide');
     	  					generalSuccessModal();
    ...
    "addDivId":"#empj_BldLimitAmountAddDiv",
    "detailInterface":"../Empj_BldLimitAmountDetail",
    "addInterface":"../Empj_BldLimitAmountSave",
