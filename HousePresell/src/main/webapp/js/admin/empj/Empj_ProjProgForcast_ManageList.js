(function (baseInfo) {
    var listVue = new Vue({
        ...
        data: {
            ...
            empj_ProjProgForcast_ManageList : [],
            //修改按钮
            upDisabled: true,
            ...
            handleList : [
            	{tableId:"-1",theName:"未审核"},
            	{tableId:"0",theName:"不通过"},
            	{tableId:"1",theName:"审核通过"},
            ],
            
            pushList : [
            	{tableId:"0",theName:"未推送"},
            	{tableId:"1",theName:"推送中"},
            	{tableId:"2",theName:"已推送"},
            ],
        ...
        methods: {
            ...
            changebuildListener: function(data){
            	listVue.buildId = data.tableId;
            },
            
            changebuildEmpty: function(){
            	listVue.buildId = null;
            },
            
            changepushListener: function(data){
            	listVue.pushId = data.tableId;
            	listVue.webPushState = data.tableId;
            },
            
            changepushEmpty: function(){
            	listVue.pushId = null;
            	listVue.webPushState = null;
            },
            
            changehandleListener: function(data){
            	listVue.handleId = data.tableId;
            	listVue.webHandelState = data.tableId;
            },
            changehandleEmpty: function(){
            	listVue.handleId = null;
            	listVue.webHandelState = null;
            },
    ...
    function getSearchForm() {
        return {
            ...
            buildId : listVue.buildId,
            pushId : listVue.pushId,
            webPushState : listVue.webPushState,
            handleId : listVue.handleId,
            webHandelState : listVue.webHandelState,
    ...
    function refresh() {
        new ServerInterface(baseInfo.listInterface).execute(listVue.getSearchForm(), function (jsonObj) {
            if (jsonObj.result != "success") {
                ...
                listVue.empj_ProjProgForcast_ManageList = jsonObj.empj_ProjProgForcast_ManageList;
                listVue.empj_ProjProgForcast_ManageList.forEach(function(item){
                ...
                //动态跳转到锚点处，id="top"
                document.getElementById('Empj_ProjProgForcast_ManageListDiv').scrollIntoView();
            }
        });
    }
    ...
    function mainDetailHandle(tableId) {
    	console.log("tableId")
    	console.log(tableId)
        enterNewTab(tableId, "工程进度巡查推送管理详情", "empj/Empj_ProjProgForcastManageDetail.shtml")
    }
    ...
    function resetSearch() {
        generalResetSearch(listVue, function () {
            ...
            listVue.buildId = "",
            listVue.pushId = "",
            listVue.webPushState = "",
            listVue.handleId = "",
            listVue.webHandelState = "",
            refresh()
        })
    }
	...
	function getBuildList() {
		changeProjectHandle(listVue,baseInfo.changeProjectInterface,function(jsonObj){
			listVue.buildList = jsonObj.empj_BuildingInfoList;
