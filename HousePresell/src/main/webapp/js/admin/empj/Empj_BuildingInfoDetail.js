(function(baseInfo){
	var detailVue = new Vue({
		...
		methods : {
			...
			buildInfoDetailExportHouseExcel:buildInfoDetailExportHouseExcel,
		},
		computed:{
...
//				})
	...
	function moveToEdit() 
	{
		enterNewTabCloseCurrent(detailVue.tableId, "编辑楼幢", "empj/Empj_BuildingInfoEdit.shtml")
	}
	...
	function buildInfoDetailExportHouseExcel()
	{
		var houseModel = {
