...
//		 	  											enterNewTabCloseCurrent(jsonObj.tableId,"受限额度变更详情","empj/Empj_DailyInspectionReportsDetail.shtml");
														...
														else
														{
															...
															new ServerInterfaceJsonBody(baseInfo.addInterface).execute(model, function(jsonObj3) {
													            ...
													            {
													            	generalSuccessModal();
													            	enterNewTabCloseCurrent(jsonObj3.tableId,"受限额度变更详情","empj/Empj_DailyInspectionReportsDetail.shtml");
													            }
															});
														}
     	  						...
     	  						$(".xszModel").modal('hide');
     	  						generalSuccessModal();
     	  						enterNewTabCloseCurrent(jsonObj.tableId,"进度节点变更详情","empj/Empj_DailyInspectionReportsDetail.shtml");
     	  					}
     	  				}else{
     	  					$(".xszModel").modal('hide');
     	  					generalSuccessModal();
    ...
    function changeVersionListener(data) {
    	...
    	/*console.log(addVue.buildingList);*/
    	/*var versionList = data.versionList;
    	if(versionList.length>0){
    		for(var i = 0;i<versionList.length;i++){
    			if(versionList[i].tableId == data.limitedId){
    				data.limitedAmount = versionList[i].limitedAmount;
    			}
    		}
    	}*/
    }
    ...
    // }
    // serverRequest("../Empj_DailyInspectionReportsIsUnique",form,function (jsonObj) {
    ...
    function listItemSelectHandle(listTotal) {
    	...
    	/*for (var j = 0; j < listTotal.length; j++)
        {
	    	for (var i = 0; i < addVue.buildingList.length; i++)
	        {
                ...
                if(addVue.buildingList[i].tableId == listTotal[j].tableId)
                {
                    count++;
                    break;
                }
            ...
            if(count>0)
            {
                addVue.buildingList[i].disabled = false;
            }else{
            	addVue.buildingList[i].disabled = true;
            	addVue.buildingList[i].limitedId = "";
                addVue.buildingList[i].limitedAmount = "";
            }
        }*/  
    ...
    "addDivId":"#Empj_DailyInspectionReportsAddDiv",
    "detailInterface":"../Empj_DailyInspectionReportsDetail",
    "addInterface":"../Empj_DailyInspectionReportsSave",
