(function(baseInfo){
	var detailVue = new Vue({
		...
		data : {
			...
			empj_DailyInspectionReportsModel: {},
			tableId : 1,
            //附件材料
			busiType:'03030204',
            dialogVisible: false,
...
// 	        	generalErrorModal(jsonObj)
	...
	function getDetail()
	{
		serverRequest(baseInfo.detailInterface,detailVue.getSearchForm(),function (jsonObj) {
			//主表数据
            detailVue.empj_DailyInspectionReportsModel = jsonObj.empj_BldLimitAmount;
            
            detailVue.empj_DailyInspectionReportsModel.businessCodeA = detailVue.empj_DailyInspectionReportsModel.businessCode + "A";
            detailVue.empj_DailyInspectionReportsModel.businessCodeB = detailVue.empj_DailyInspectionReportsModel.businessCode + "B";
            //子表数据
            detailVue.buildingList = jsonObj.empj_BldLimitAmount.dtlList;
            
            detailVue.trusteeshipContent=jsonObj.trusteeshipContent
            if(detailVue.tableId==1){
                detailVue.tableId=detailVue.empj_DailyInspectionReportsModel.tableId
			}
			if(detailVue.empj_DailyInspectionReportsModel.approvalState == "待提交"){
				detailVue.editFile = true;
			}
			changeThousands();
        })
	...
	function mainEditHandle() {
        enterNewTabCloseCurrent(detailVue.tableId,"受限额度变更编辑","empj/Empj_DailyInspectionReports_AFEdit.shtml")
    }
    ...
    function changeThousands() {
        // detailVue.empj_DailyInspectionReportsModel.recordAveragePriceOfBuilding=addThousands(detailVue.empj_DailyInspectionReportsModel.recordAveragePriceOfBuilding)
        detailVue.empj_DailyInspectionReportsModel.recordAveragePriceOfBuilding=addThousands(detailVue.empj_DailyInspectionReportsModel.recordAveragePriceOfBuilding)
        detailVue.empj_DailyInspectionReportsModel.orgLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.orgLimitedAmount)
        detailVue.empj_DailyInspectionReportsModel.nodeLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.nodeLimitedAmount)
        detailVue.empj_DailyInspectionReportsModel.effectiveLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.effectiveLimitedAmount)
        detailVue.empj_DailyInspectionReportsModel.totalGuaranteeAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.totalGuaranteeAmount)
        detailVue.empj_DailyInspectionReportsModel.expectEffectLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.expectEffectLimitedAmount)
        detailVue.empj_DailyInspectionReportsModel.cashLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.cashLimitedAmount)
        detailVue.empj_DailyInspectionReportsModel.expectLimitedAmount=addThousands(detailVue.empj_DailyInspectionReportsModel.expectLimitedAmount)
    }
  ...
  //列表操作-----------------------导出PDF
	...
	"detailDivId":"#empj_DailyInspectionReportsDetailDiv",
	"detailInterface":"../Empj_BldLimitAmountDetail",
	"exportInterface":"../exportPDFByWord",//导出pdf
    //附件读取
    "loadUploadInterface":"../Sm_AttachmentCfgList",
    "submitInterface":"../Empj_DailyInspectionReportsSubmit",//提交
    "editFileInterface":"../Empj_DailyInspectionReportsEdit",//修改附件信息
