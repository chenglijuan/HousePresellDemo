        ...
        new ServerInterface(baseInfo.listInterface).execute(listVue.getSearchForm(), function (jsonObj) {
            if (jsonObj.result != "success") {
                ...
                listVue.empj_ProjProgInspectionList.forEach(function(item) {
					...
					item.guaranteeAmount = addThousands(item.guaranteeAmount);
...
//                document.getElementById('Empj_ProjProgInspectionListDiv').scrollIntoView();
    ...
    function mainDetailHandle(tableId) {
        enterNewTab(tableId, "楼幢预测信息详情", "empj/Empj_ProjProgInspectionViewDetail.shtml")
    }
    ...
    "listDivId": "#Empj_ProjProgInspectionViewListDiv",
    "updateDivId": "#updateModel",
    "addDivId": "#addModal",
    "exportInter": "../Empj_ProjProgInspectionExeport",//导出
    "listInterface": "../Empj_ProjProgInspection_AFViewList",
