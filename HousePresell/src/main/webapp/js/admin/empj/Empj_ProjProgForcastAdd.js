...
//		 	  											enterNewTabCloseCurrent(jsonObj.tableId,"受限额度变更详情","empj/Empj_ProjProgForcastDetail.shtml");
														...
														else
														{
															...
															new ServerInterfaceJsonBody(baseInfo.addInterface).execute(model, function(jsonObj3) {
													            ...
													            {
													            	generalSuccessModal();
													            	enterNewTabCloseCurrent(jsonObj3.tableId,"受限额度变更详情","empj/Empj_ProjProgForcastDetail.shtml");
													            }
															});
														}
     	  						...
     	  						$(".xszModel").modal('hide');
     	  						generalSuccessModal();
     	  						enterNewTabCloseCurrent(jsonObj.tableId,"进度节点变更详情","empj/Empj_ProjProgForcastDetail.shtml");
     	  					}
     	  				}else{
     	  					$(".xszModel").modal('hide');
     	  					generalSuccessModal();
    ...
    // }
    // serverRequest("../Empj_ProjProgForcastIsUnique",form,function (jsonObj) {
    ...
    "addDivId":"#Empj_ProjProgForcastAddDiv",
    "detailInterface":"../Empj_ProjProgForcastDetail",
    "addInterface":"../Empj_ProjProgForcastSave",
