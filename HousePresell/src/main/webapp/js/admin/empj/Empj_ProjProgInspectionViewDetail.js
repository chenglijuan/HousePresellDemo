...
// 	        	generalErrorModal(jsonObj)
	...
	function getDetail()
	{
		serverRequest(baseInfo.detailInterface,detailVue.getSearchForm(),function (jsonObj) {
            ...
            detailVue.empj_ProjProgInspectionModel.currentEscrowFund = addThousands(detailVue.empj_ProjProgInspectionModel.currentEscrowFund);
            ...
            detailVue.empj_ProjProgInspectionModel.guaranteeAmount = addThousands(detailVue.empj_ProjProgInspectionModel.guaranteeAmount);
            ...
            detailVue.buildingList.forEach(function(item) {
				item.cashLimitAmount = addThousands(item.cashLimitAmount);
				item.nodeLimitAmount = addThousands(item.nodeLimitAmount);
				item.effLimitAmount = addThousands(item.effLimitAmount);
				item.applyAmount = addThousands(item.applyAmount);
			});
  ...
  //列表操作-----------------------导出PDF
	...
	"detailDivId":"#empj_ProjProgInspectionViewDetailDiv",
	"detailInterface":"../Empj_ProjProgInspection_AFViewDetail",
