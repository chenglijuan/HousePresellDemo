(function(baseInfo){
	...
	function getDetail()
	{
		new ServerInterface(baseInfo.detailInterface).execute(detailVue.getSearchForm(), function(jsonObj)
		{
			...
			{
				detailVue.tg_HandleTimeLimitConfigModel = jsonObj.tg_HandleTimeLimitConfig;
			}
		});
	}
	...
	"detailDivId":"#tg_HandleTimeLimitConfigDiv",
	"detailInterface":"../Tg_HandleTimeLimitConfigDetail",
