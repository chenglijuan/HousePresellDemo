(function(baseInfo){
	...
	function getAddForm()
	{
		return {
			...
			eCodeOfCompany:this.eCodeOfCompany,
			fullNameOfCompanyFromFinanceSystem:this.fullNameOfCompanyFromFinanceSystem,
			shortNameOfCompanyFromFinanceSystem:this.shortNameOfCompanyFromFinanceSystem,
			...
			shortNameOfProjectFromFinanceSystem:this.shortNameOfProjectFromFinanceSystem,
	...
	"addDivId":"#tgpf_FundAccountInfoDiv",
