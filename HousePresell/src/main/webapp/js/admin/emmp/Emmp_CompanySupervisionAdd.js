(function(baseInfo){
	var addVue = new Vue({
		...
		methods : {
			...
			add : addEmmp_CompanySupervision,
            getSubmitForm : getSubmitForm,
            submit : submitEmmp_CompanySupervision,
			initValue : initValue,
	...
	function getAddForm()
	{
		return {
			...
			registeredDateStr:$('#date0201310101').val(),
	...
	function addEmmp_CompanySupervision()
	{
		...
		new ServerInterfaceJsonBody(baseInfo.addInterface).execute(addVue.getAddForm(), function(jsonObj){
            ...
            {
                generalSuccessModal();
                enterNewTabCloseCurrent(jsonObj.emmp_CompanyInfo.tableId, '监理机构详情', 'emmp/Emmp_CompanySupervisionDetail.shtml');
            }
		});
	}
    ...
    function submitEmmp_CompanySupervision()
    {
    	addVue.flag  = true;
	...
	"addDivId":"#emmp_CompanySupervisionAddDiv",
	"addInterface":"../Emmp_CompanySupervisionAdd",
	//机构成员
