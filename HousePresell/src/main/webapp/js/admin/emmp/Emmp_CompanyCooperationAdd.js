(function(baseInfo){
	var addVue = new Vue({
		...
		methods : {
			...
			add : addEmmp_CompanyCooperation,
            getSubmitForm : getSubmitForm,
            submit : submitEmmp_CompanyCooperation,
			initValue : initValue,
	...
	function getAddForm()
	{
		return {
			...
			registeredDateStr:$('#date0201080101').val(),
	...
	function addEmmp_CompanyCooperation()
	{
		...
		new ServerInterfaceJsonBody(baseInfo.addInterface).execute(addVue.getAddForm(), function(jsonObj){
            ...
            {
                generalSuccessModal();
                enterNewTabCloseCurrent(jsonObj.emmp_CompanyInfo.tableId, '合作机构详情', 'emmp/Emmp_CompanyCooperationDetail.shtml');
            }
		});
	}
    ...
    function submitEmmp_CompanyCooperation()
    {
    	addVue.flag  = false;
    ...
    function handleSelectionChange(val) {
        ...
        // {
        //     //以备修改
        //     addVue.updateOrgMemberModel = val[0];
        // } else {
        //     addVue.updateOrgMemberModel = {};
        // }
    }
	...
	"addDivId":"#emmp_CompanyCooperationAddDiv",
	"addInterface":"../Emmp_CompanyCooperationAdd",
	//机构成员
