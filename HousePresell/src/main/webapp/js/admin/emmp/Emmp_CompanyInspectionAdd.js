(function(baseInfo){
	var addVue = new Vue({
		...
		methods : {
			...
			add : addEmmp_CompanyInspection,
            getSubmitForm : getSubmitForm,
            submit : submitEmmp_CompanyInspection,
			initValue : initValue,
	...
	function getAddForm()
	{
		return {
			...
			registeredDateStr:$('#date0201410101').val(),
	...
	function addEmmp_CompanyInspection()
	{
		...
		new ServerInterfaceJsonBody(baseInfo.addInterface).execute(addVue.getAddForm(), function(jsonObj){
            ...
            {
                generalSuccessModal();
                enterNewTabCloseCurrent(jsonObj.emmp_CompanyInfo.tableId, '无人机巡查机构详情', 'emmp/Emmp_CompanyInspectionDetail.shtml');
            }
		});
	}
    ...
    function submitEmmp_CompanyInspection()
    {
    	addVue.flag  = true;
	...
	"addDivId":"#emmp_CompanyInspectionAddDiv",
	"addInterface":"../Emmp_CompanyInspectionAdd",
	//机构成员
