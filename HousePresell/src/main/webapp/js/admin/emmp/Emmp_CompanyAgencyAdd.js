(function(baseInfo){
	var addVue = new Vue({
		...
		methods : {
			...
			add : addEmmp_CompanyAgency,
            getSubmitForm : getSubmitForm,
            submit : submitEmmp_CompanyAgency,
			initValue : initValue,
	...
	function getAddForm()
	{
		return {
			...
			registeredDateStr:$('#date0201030101').val(),
	...
	function addEmmp_CompanyAgency()
	{
		...
		new ServerInterfaceJsonBody(baseInfo.addInterface).execute(addVue.getAddForm(), function(jsonObj){
            ...
            {
                generalSuccessModal();
                enterNewTabCloseCurrent(jsonObj.emmp_CompanyInfo.tableId, '代理公司详情', 'emmp/Emmp_CompanyAgencyDetail.shtml');
            }
		});
	}
    ...
    function submitEmmp_CompanyAgency()
    {
    	addVue.flag = false;
	...
	"addDivId":"#emmp_CompanyAgencyAddDiv",
	"addInterface":"../Emmp_CompanyAgencyAdd",
	//机构成员
    "addPersonModal":"#addPerson87",
