(function(baseInfo){
	var detailVue = new Vue({
		...
		data : {
			...
			empj_BuildingAccountSupervisedModel: {},
			tableId : 1,
		},
		methods : {
			//详情
	...
	function getDetail()
	{
		new ServerInterface(baseInfo.detailInterface).execute(detailVue.getSearchForm(), function(jsonObj)
		{
			...
			{
				detailVue.empj_BuildingAccountSupervisedModel = jsonObj.empj_BuildingAccountSupervised;
			}
		});
	}
	...
	"detailDivId":"#empj_BuildingAccountSupervisedDiv",
	"detailInterface":"../Empj_BuildingAccountSupervisedDetail",
