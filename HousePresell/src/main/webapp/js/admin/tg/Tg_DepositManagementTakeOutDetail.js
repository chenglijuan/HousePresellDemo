...
//                detailVue.tg_DepositManagementModel.floatAnnualRate = addThousands(detailVue.tg_DepositManagementModel.floatAnnualRate);
                detailVue.tg_DepositManagementModel.realInterest = addThousands(detailVue.tg_DepositManagementModel.realInterest);
                detailVue.tg_DepositManagementModel.realInterestRate = addThousands(detailVue.tg_DepositManagementModel.realInterestRate);
                
                if(undefined != detailVue.tg_DepositManagementModel.annualRate && "" != detailVue.tg_DepositManagementModel.annualRate	
	               && undefined != detailVue.tg_DepositManagementModel.realInterestRate && "" != detailVue.tg_DepositManagementModel.realInterestRate
                   ){
	                 ...
	                 detailVue.tg_DepositManagementModel.realInterestRate = Number(detailVue.tg_DepositManagementModel.realInterestRate).toFixed(3);
	            }
	...
	// {
    //     enterNewTabCloseCurrent(detailVue.tableId, '存单提取修改', 'tg/Tg_DepositManagementTakeOutEdit.shtml');
	// }
	...
	"detailDivId":"#tg_DepositManagementTakeOutDetailDiv",
