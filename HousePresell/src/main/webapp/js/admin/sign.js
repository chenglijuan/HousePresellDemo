(function(baseInfo){
	...
	{
		//1.打开本地文件
//		var isOpen = TZPdfViewer.TZOpenPdfByPath("D:\项目开发\资金托管\资料\WebPdf调用Demo\TZWebPdf\1.pdf",0);
		...
		//2.根据关键字签章
		var isSuccess = TZPdfViewer.TZInsertESealByKeyWord("甲方（盖章）");
		alert("2.根据关键字签章="+isSuccess);
		
		//3.保存到本地路径
		var isSave = TZPdfViewer.SaveAs("D:\\啦啦啦.pdf");
