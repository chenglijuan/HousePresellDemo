(function(baseInfo){
	...
	function getDetail()
	{
		new ServerInterface(baseInfo.detailInterface).execute(detailVue.getSearchForm(), function(jsonObj)
		{
			...
			{
				detailVue.tgpf_SerialNumberModel = jsonObj.tgpf_SerialNumber;
			}
		});
	}
	...
	"detailDivId":"#tgpf_SerialNumberDiv",
	"detailInterface":"../Tgpf_SerialNumberDetail",
	"updateInterface":"../Tgpf_SerialNumberUpdate"
});
