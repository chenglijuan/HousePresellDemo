(function(baseInfo){
	var addVue = new Vue({
		...
		data : {
		    ...
		    rejectModelList : [
		    	{tableId:"0",theName:"驳回到发起人"},
		    	{tableId:"1",theName:"驳回到上一环节"},
		    ] 
		},
		mounted: function () {
	      // this.getOrderNumber();
		...
		methods : {
			...
			deleteRow:deleteRow,
	      	...
	      	isNeedBackupChange : function(data){
	      		addVue.sm_ApprovalProcess_CfgModel.isNeedBackup = data.tableId; 
	      	},
	      	emptyIsNeedBackup : function(){
	      		addVue.sm_ApprovalProcess_CfgModel.isNeedBackup = null;
	      	},
	      	rejectModelChange : function(data){
	      		addVue.sm_ApprovalProcess_NodeModel.rejectModel = data.tableId;
	      	}
        },
		computed:{
    ...
    function showModal()
    {
        ...
        addVue.sm_ApprovalProcess_NodeModel.rejectModel = null;//驳回模式
    ...
    function sm_MessageTemplate_CfgDetail(tableId)
    {
        ...
        enterNewTab(tableId, "消息模板配置详情", "sm/Sm_MessageTemplate_CfgDetail.shtml");
    }
    ...
    function addSm_ApprovalProcess_Cfg()
    {
        new ServerInterface(baseInfo.addInterface).execute(addVue.getAddForm(), function(jsonObj){
            ...
            {
                generalSuccessModal();
                enterNewTabCloseCurrent(jsonObj.tableId,"审批流程设置详情",'sm/Sm_ApprovalProcess_CfgDetail.shtml')
            }
        });
    }
