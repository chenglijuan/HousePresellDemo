...
//			pageNumber : refresh,
	...
	{
        enterNewTab("", "新增审批流程设置", "sm/Sm_ApprovalProcess_CfgAdd.shtml");
	}
    ...
    function sm_ApprovalProcess_CfgEdit()
    {
        ...
        enterNewTab(tableId, "审批流程设置修改", "sm/Sm_ApprovalProcess_CfgEdit.shtml");
    }

    //进入详情
    function sm_ApprovalProcess_CfgDetail(tableId)
    {
        enterNewTab(tableId, "审批流程设置详情", "sm/Sm_ApprovalProcess_CfgDetail.shtml");
    }
