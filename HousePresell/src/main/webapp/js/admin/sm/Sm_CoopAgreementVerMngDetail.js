...
//				noty({"text":jsonObj.info,"type":"error","timeout":2000});
			...
			{
				detailVue.tgxy_CoopAgreementVerMngModel = jsonObj.Tgxy_CoopAgreementVerMng;
